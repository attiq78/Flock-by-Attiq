      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <div className="flex justify-center">
          <div className="flex items-center space-x-3">
            ...
            <span className="text-3xl font-bold text-white">FlockByAttiq</span>
          </div>
        </div> */}
        ...
        <div className="bg-white/10 backdrop-blur-xl py-8 px-4 shadow-2xl sm:rounded-2xl sm:px-10 border border-white/20">
            ...
            <div>
              ...
              <div className="mt-1 relative">
                ...
                <input
                  ...
                  className="appearance-none block w-full pl-10 pr-3 py-3 border border-white/30 rounded-xl placeholder-white/50 bg-white/10 text-white focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all duration-200"
            ...
            <div>
              ...
              <div className="mt-1 relative">
                ...
                <input
                  ...
                  onChange={handleChange}
                  className="appearance-none block w-full pl-10 pr-10 py-3 border border-white/30 rounded-xl placeholder-white/50 bg-white/10 text-white focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all duration-200"
          ...
          <div className="mt-8">
            ...
            <div className="mt-6 grid grid-cols-2 gap-3">
              <button className="w-full inline-flex justify-center py-3 px-4 border border-white/30 rounded-xl shadow-sm bg-white/10 text-sm font-medium text-white hover:bg-white/20 transition-all duration-200">
